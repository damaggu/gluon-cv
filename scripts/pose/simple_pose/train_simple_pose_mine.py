...
def get_data_loader(data_dir, batch_size, num_workers, input_size):
    ...
    with open('/home/nexus/github/gluon_tests/primate_keypoints.pkl', 'rb') as f:
    ...
    transform_train = SimplePoseDefaultTrainTransform(num_joints=num_joints,
                                                      joint_pairs=pairs,
...
def train(ctx):
    ...
    for epoch in range(opt.num_epochs):
        ...
        #logger.info('batch done ---loss:' + str(loss_val))
